...
full_metal_jacket = media.Movie("Full Metal Jacket",
                                "A few marines arrive at boot camp and get the training of their life.",
...
hackers = media.Movie("Hackers",
                      "A few fun loving hackers get blamed for something the didn't do",
...
star_wars = media.Movie("Star Wars: The Force Awakens",
                        "Disney aquired Lucas Films and thought they could make a better movie",
                        "https://upload.wikimedia.org/wikipedia/en/a/a2/Star_Wars_The_Force_Awakens_Theatrical_Poster.jpg",
                        "https://www.youtube.com/watch?v=sGbxmsDFVnE")

the_matrix = media.Movie("The Matrix",
                         "Reality is only perceived reality and the ones who do not know must be secretly protected",
                         "https://upload.wikimedia.org/wikipedia/en/c/c1/The_Matrix_Poster.jpg",
                         "https://www.youtube.com/watch?v=vKQi3bBA1y8")
"""
Defines a hard coded set of data that can be used to demonstrate the look and feel of the site.
"""
class SampleMovies:
    """A quick and dirty way to represent a List[] of movies hard coded in the current module.

    """


    sample_movies = []  # A sample list of movies the user can preload to test the page.
    ...
    def __init__(self):
        ...
        self.sample_movies = [toy_story, avatar, full_metal_jacket, hackers, star_wars, the_matrix]
